...
urlpatterns = patterns('',
                       ...
                       # MapLoom
                       url(r'^story/new$', new_map, {'template': 'composer/maploom.html'},name='new-story'),
                       ...
                       url(r'^story/(?P<slug>[-\w]+)/draft$', 'mapstory.views.draft_view', {'template': 'composer/maploom.html'}, name='maploom-map-view'),
                       url(r'^frame/(?P<storyid>[^/]+)/draft', 'mapstory.views.draft_view',name='draft_view'),

                       # Composer-new
                       url(r'^story/(?P<slug>[-\w]+)/composer$', 'mapstory.views.composer_new_view', {'template': 'composer_new/composer.html'}, name='composer-view'),
                       ...
                       url(r'^opensensorhub/', include('mapstory.apps.opensensorhub.urls', namespace='opensensorhub')),
